...
contract PULSEX is IERC20 {
    string public constant name = "Pulsex Token";
    ...
    uint256 private _buyTaxPercentage = 800; // 8%
    uint256 private _sellTaxPercentage = 1000; // 10%
    ...
    constructor() {
        ...
        tradingEnabled = true; // Trading is enabled by default
